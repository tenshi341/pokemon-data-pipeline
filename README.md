...
Access the Airflow web interface at localhost port 8080. Enable the primary DAG named smogon_elt_pipeline to commence the data ingestion and transformation process.
...
docker exec -it airflow-scheduler python scripts/run_simulation.py --battles 1000
Database Schema
